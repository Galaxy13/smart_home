    ...
    for stream in listener.incoming() {
        ...
        match command {
            ...
            [2_u8] => {
                ...
                println!(
                    "Consumption of power plug {} is {}",
                    power_plug.get_name(),
                    power_plug.current_consumption()
                );
            }
            [3_u8] => {
                ...
                println!(
                    "Current state of power plug {} is {}",
                    power_plug.get_name(),
                    power_plug.current_state()
                );
            }
            [4_u8] => {
            ...
            _ => {
                handle_request(AnswerCode::InternalError, &stream, &[]).unwrap();
            }
        }

...
mod tests{
    ...
    fn room_names_in_home_test(){
        ...
        assert_eq!(smarthome.get_rooms_names().unwrap_or_default().sort(), vec![String::from("Kitchen"),
    ...
    fn unique_room_name(){
        ...
        smarthome.create_room("Test");
        assert_eq!(smarthome.get_rooms_names().unwrap_or_default().sort(), vec![String::from("Test"), String::from("Test2")].sort());
